                    ...
                    >
                        ...
                        >
                            ...
                            /> */}
                                <div style={{width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between"}}>
                                    <div style={{ marginRight: "10px",width: "100px",padding: "5px", border: "2px solid gray", borderRadius: "80px", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                        <Avatar style={{width: "80px", height: "80px", objectFit: "cover"}} src={student_PNG} />
                                    </div>
                                    <div style={{display: "flex", flexDirection: "column"}}>
                                        <Title level={4} >Artyom Bordulanyuk</Title>
                                        <Paragraph copyable={{ text: 'artyom.bordulanyuk@gmail.com' }}>artyom.bordulanyuk@gmail.com</Paragraph>
                                        <a href="tel: +37491730250" style={{color: "black",textDecoration: "none", fontSize: "18px"}} >+374 (91)73-05-50</a>
                                    </div>
                                </div>
                            </Skeleton>
                        </Card>
                        ...
                        >
                            <Skeleton loading={loading} active>
                                <div style={{width: "100%", height: "100%", display: "flex", alignItems: "center" , flexDirection: "column", justifyContent: "space-between"}}>
                                    <div style={{ marginRight: "10px",width: "100px",padding: "5px", border: "2px solid gray", borderRadius: "80px", display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "15px"}}>
                                        <Avatar style={{width: "80px", height: "80px", objectFit: "cover"}} src={frontEnd_PNG} />
                                    </div>
                                    <div style={{display: "flex", flexDirection: "column"}}>
                        ...
                        >
                            <Card style={{marginTop: "10px"}} >
                               <div style={{ width: "100%", display: "flex", justifyContent: "space-between" }}>
                                    <div style={{width: "70px", height: "70px"}}>
                                            <img style={{width: "100%", height: "100%", objectFit: "cover"}} src={html_SVG} alt="html" />
                                    </div>
                            ...
                            <Card style={{marginTop: "10px"}} >
                               <div style={{ width: "100%", display: "flex", justifyContent: "space-between" }}>
                                    <div style={{width: "70px", height: "70px"}}>
                                            <img style={{width: "100%", height: "100%", objectFit: "cover"}} src={css_SVG} alt="css" />
                                    </div>
                            ...
                            <Card style={{marginTop: "10px"}} >
                               <div style={{ width: "100%", display: "flex", justifyContent: "space-between" }}>
                                    <div style={{width: "70px", height: "70px"}}>
                                            <img style={{width: "100%", height: "100%", objectFit: "cover"}} src={javaScript_SVG} alt="JavaScript" />
                                    </div>
